...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedLanguage.isEmpty()) {
            context = LocaleHelper.setLocale(this, "");
        } else {
            context = LocaleHelper.setLocale(this, selectedLanguage);
        }
        resources = context.getResources();
        totalquestions = SharedPreferencesUtils.getTotalQuestions(this, 0);
        totalCorrectAnswer = SharedPreferencesUtils.getTotalCorrectAnswers(this, 0);
...
//                    Toast.makeText(MainActivity.this, "enddddddddd", Toast.LENGTH_SHORT).show();
    ...
    private void addQuestions() {
        ...
        questionItems.add(new QuestionItem(resources.getString(R.string.question1), "False"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question2), "False"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question3), "True"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question4), "True"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question5), "False"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question6), "True"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question7), "True"));
        questionItems.add(new QuestionItem(resources.getString(R.string.question8), "True"));
...
//
    ...
    private void showResultDialog(String question) {
        ...
        builder.setTitle(resources.getString(R.string.result)).setMessage(resources.getString(R.string.your_result) + correctAnswers + resources.getString(R.string.out_of) + questions).setCancelable(false).setPositiveButton(resources.getString(R.string.save), (dialogInterface, i) -> {
            ...
            SharedPreferencesUtils.saveTotalQuestions(this, totalquestions);
            SharedPreferencesUtils.saveTotalCorrectAnswers(this, totalCorrectAnswer);
    ...
    private void showLanguageDialog() {
        ...
        TextView tvUrdu = dialogView.findViewById(R.id.tvUrdu);
    ...
    public void onLanguageSelected(View view) {
        ...
        context = LocaleHelper.setLocale(this, selectedLanguage);
        resources = context.getResources();
        SharedPreferencesUtils.saveLanguage(this, selectedLanguage);
        recreate();
    }

    private void showAverageDialog() {
        int a = SharedPreferencesUtils.getTotalCorrectAnswers(this, 0);
        int b = SharedPreferencesUtils.getTotalQuestions(this, 0);
//        int c=a/b;
        DialogUtils.showAlertDialog(this, null, resources.getString(R.string.message_average) + a + "/" + b, resources.getString(R.string.ok), resources.getString(R.string.cancel), new Runnable() {
            @Override
            public void run() {
...
//                        updateQuestionInFragment(null);
    ...
    private void showResetConfirmationDialog() {
        SharedPreferencesUtils.deleteTotalCorrectAnswers(this);
        SharedPreferencesUtils.deleteTotalQuestions(this);
        totalquestions = SharedPreferencesUtils.getTotalQuestions(this, 0);
        totalCorrectAnswer = SharedPreferencesUtils.getTotalCorrectAnswers(this, 0);

        DialogUtils.showAlertDialog(this, null, resources.getString(R.string.message_average) + totalCorrectAnswer + "/" + totalquestions, resources.getString(R.string.ok), resources.getString(R.string.cancel), new Runnable() {
            @Override
            public void run() {
                // Positive button callback logic
                // Add your functionality here
