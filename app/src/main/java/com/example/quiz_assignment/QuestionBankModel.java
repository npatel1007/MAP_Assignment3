...
public class QuestionBankModel {
    ...
    public void addQuestion(ArrayList<QuestionItem> question, ArrayList<Integer> color) {
        questionList=question;
        colorList=color;
    }
    public void addQuestionList(ArrayList<QuestionItem> questions, ArrayList<Integer> colors) {
